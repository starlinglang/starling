...
var $747425b437e121da$require$toAST = $2iNG1$toAST;
var $d7ac343f36c3ad7c$exports = {};

const $d7ac343f36c3ad7c$var$starlingGrammar = String.raw`
  Starling {
...
$d7ac343f36c3ad7c$exports = {
  starlingGrammar: $d7ac343f36c3ad7c$var$starlingGrammar,
};

var $747425b437e121da$require$grammarString =
  $d7ac343f36c3ad7c$exports.starlingGrammar;
var $cd27a9f14bcc7980$exports = {};
let $cd27a9f14bcc7980$var$actions = {
  Database(stmts) {
...
function $cd27a9f14bcc7980$var$resolveReferences(arr) {
  const labelMap = {};
  arr.forEach((item) => {
...
$cd27a9f14bcc7980$exports = {
  actions: $cd27a9f14bcc7980$var$actions,
  resolveReferences: $cd27a9f14bcc7980$var$resolveReferences,
};

var $747425b437e121da$require$actions = $cd27a9f14bcc7980$exports.actions;

var $747425b437e121da$require$resolve =
  $cd27a9f14bcc7980$exports.resolveReferences;
var $9333733b00ab78ee$exports = {};
function $9333733b00ab78ee$var$transpile(ast) {
  const output = [];
  const statements = {
    imports: [],
    constants: [],
...
$9333733b00ab78ee$exports = {
  transpile: $9333733b00ab78ee$var$transpile,
};

var $747425b437e121da$require$transpile = $9333733b00ab78ee$exports.transpile;
var $9f10d0d95b8dae89$exports = {};
// longTest.star
let $9f10d0d95b8dae89$var$longTest = `
...
`;
//shortTest.star
let $9f10d0d95b8dae89$var$shortTest = `
  ...
  `;
$9f10d0d95b8dae89$exports = {
  shortTest: $9f10d0d95b8dae89$var$shortTest,
  longTest: $9f10d0d95b8dae89$var$longTest,
};

var $747425b437e121da$require$shortTest = $9f10d0d95b8dae89$exports.shortTest;
var $747425b437e121da$require$longTest = $9f10d0d95b8dae89$exports.longTest;
let $747425b437e121da$var$compile = (string) => {
  let langGrammar = $2iNG1$grammar($747425b437e121da$require$grammarString);
  const s = langGrammar
    .createSemantics()
    .addOperation("makeAST", $747425b437e121da$require$actions);
  const matchResult = langGrammar.match(string);
  const adapter = s(matchResult).makeAST();
  const ast = $747425b437e121da$require$resolve(adapter);
  return [ast, $747425b437e121da$require$transpile(ast)];
};
$747425b437e121da$exports = {
  compile: $747425b437e121da$var$compile,
};
